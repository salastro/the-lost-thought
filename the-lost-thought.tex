...
\usepackage[a4paper, inner=1.5in, outer=0.80in, bottom=2.5in]{geometry}
...
\backgroundsetup{
	...
	contents={
		\checkoddpage
		\ifoddpage
			\includegraphics[width=\paperwidth]{images/border-double-odd.pdf}
		\else
			\includegraphics[width=\paperwidth]{images/border-double-even.pdf}
		\fi
	}
}

% \CenterWallPaper{1}{images/border-double-odd.pdf}
...
% This book, consequently, dives into the unexplored territories of thought.

\mainmatter

\chapter{The Collective}
% \section{Before individuality}
